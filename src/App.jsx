...
const App = () => {
  ...
  const dataToUse = data.length > 0 ? data : tempData;
  ...
  return (
    <main className="min-h-screen p-12 ring-2 ring-accen flex gap-24">
      <ButtonContainer
        data={dataToUse}
        handleClick={handleClick}
        activeId={activeId}
      />
      <ContentContainer data={dataToUse} activeId={activeId} />
    </main>
  );
};
export default App;
